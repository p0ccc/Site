...
function setgraph(a, n, l, r) {
    trval = n, x = ((n = (n = r < n ? r : n) < l ? l : n) - l) / (r - l) * 100, x <= 30 && (x = 30), 100 == x && (x = 30), xs = String(x) + String.fromCharCode(37), e = "#" + a + "b", $(e).animate({
        width: xs,
        speed: "fast"
